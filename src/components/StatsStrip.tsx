...
export function StatsStrip({ tasks }: StatsStripProps) {
  ...
  return (
    <section className="flex flex-col gap-4 rounded-3xl border border-border-subtle bg-elevated p-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-wrap items-center gap-6">
        <div className="flex items-center gap-2">
          <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-accent-muted text-accent">
        ...
        <div className="flex items-center gap-4 text-sm">
          <span className="flex items-center gap-1.5 text-slate-200">
            ...
            <span className="text-slate-400">
              {active === 1 ? "tarefa sem concluir" : "tarefas sem concluir"}
            </span>
          </span>
          <span className="flex items-center gap-1.5 text-slate-200">
            ...
            <span className="text-slate-400">
              {done === 1 ? "tarefa concluída" : "tarefas concluídas"}
            </span>
          </span>
          {starred > 0 && (
      ...
      <div className="h-2 w-full overflow-hidden rounded-full bg-charcoal sm:max-w-xs">
        <div
          className="h-full rounded-full bg-gradient-to-r from-accent to-accent/70 transition-[width] duration-500"
          style={{ width: `${pct}%` }}
        />
      </div>
    </section>
